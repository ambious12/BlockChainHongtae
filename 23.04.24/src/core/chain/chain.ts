import { DIFFICULTY_ADJUST_INTERVAL, GENESIS } from '@constants/block.constants'
import { IBlock } from '@core/block/block.interface'

// Chain ? 블럭을 저장하는 역할..
class Chain {
    private readonly INTERVAL: number = DIFFICULTY_ADJUST_INTERVAL
    ...
    public getBlock(callbackFn: (block: IBlock) => boolean) {
        ...
        if (!findBlock) throw new Error('블럭을 못찾겠어요')
        return findBlock
    }
