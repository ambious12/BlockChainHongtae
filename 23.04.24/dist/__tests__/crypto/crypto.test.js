...
describe('CryptoModule', () => {
    let cryptoModule;
    beforeEach(() => {
        cryptoModule = new crypto_module_1.default();
    });
    describe('SHA256', () => {
    ...
    describe('createBlockHash', () => {
        it('createBlockHash에서 BLOCKINFO 데이터로 암호화가 진행되는가 ?', () => {
            ...
            const blockinfo = {
                version: block_constants_1.GENESIS.version,
                height: block_constants_1.GENESIS.height,
                timestamp: block_constants_1.GENESIS.timestamp,
                previousHash: block_constants_1.GENESIS.previousHash,
                merkleRoot: block_constants_1.GENESIS.merkleRoot,
                nonce: block_constants_1.GENESIS.nonce,
                difficulty: block_constants_1.GENESIS.difficulty,
                data: '',
            };
    ...
    describe('merkleRoot', () => {
        it('GENESIS 블럭에 있는 data값에서 merkleRoot 구하기', () => {
            const merkleroot = cryptoModule.merkleRoot(block_constants_1.GENESIS.data);
